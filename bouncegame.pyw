...
canvas = Canvas(root, width=500, height=500, bd=0, highlightthickness=0, highlightbackground="Red", bg="seagreen")
canvas.pack(padx=10, pady=10)
score = Label(height=50, width=80, text="Score: 00", font="Helvetica 14 bold")
...
root.bind_all("<Button 1>", start_game)
canvas.create_text(250, 250, text="Click to start!!", fill="red", font="Helvetica 18")
j = canvas.find_all()
root.mainloop()
